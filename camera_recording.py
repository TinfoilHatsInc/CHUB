...
def test():
    ...
    intruder = 0
    face_cascade = cv2.CascadeClassifier('/Users/thibaud/Documents/Rotterdam/Project4/CHUB/CHUB/haarcascade_frontalface_default.xml')
    eye_cascade = cv2.CascadeClassifier('/Users/thibaud/Documents/Rotterdam/Project4/CHUB/CHUB/haarcascade_eye.xml')
